          ...
          <button
            ...
            className={`rounded-full border px-3.5 py-1.5 text-xs font-medium transition ${
              mode === option.value
                ...
                : "border-zinc-700 bg-black text-zinc-600 hover:border-brand hover:text-brand-text"
            }`}
          >
            {option.label}
          </button>
      ...
      {mode === "upload" && (
        <div className="mt-3">
          {preview ? (
            ...
            <label className="inline-block cursor-pointer rounded-xl border border-dashed border-zinc-700 px-4 py-2.5 text-xs text-zinc-600 hover:border-brand hover:text-brand-text">
              Choose an image...
              <input
                type="file"
