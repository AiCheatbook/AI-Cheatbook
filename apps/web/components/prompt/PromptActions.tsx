  ...
  return (
    <div className="mt-6 flex flex-col gap-3 sm:flex-row">
      ...
      <button
        type="button"
        onClick={handleCopy}
        className="rounded-xl bg-orange-500 px-6 py-4 font-semibold text-white transition hover:bg-orange-600"
      >
        {copied
          ? "✓ Copied"
          : "📋 Copy Prompt"}
      ...
      <button
        ...
        className="rounded-xl border border-zinc-700 px-6 py-4 font-semibold text-white transition hover:border-orange-500 disabled:cursor-not-allowed disabled:opacity-40"
      >
        {saved ? "✓ Saved" : "❤️ Save"}
      </button>
      ...
      <button
        type="button"
        onClick={handleShare}
        className="rounded-xl border border-zinc-700 px-6 py-4 font-semibold text-white transition hover:border-orange-500"
      >
        {shared
          ? "✓ Link Copied"
          : "🔗 Share"}
